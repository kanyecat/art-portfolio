...
const FeatureCard = ({image, title, content, style, size, link, index}) => (
  ...
  >
    ...
    className= {`flex md:flex-row flex-col md:pb-10 pb-8 ${style} ${index !== diy.length -1 ? "mb-4" : "mb-0"}`}
    >
      <Link to={link}>
        <Tilt
          options={{
...
const DIYDF = () => {
  return (
    <div id='diydf' className='bg-primary w-full overflow-hidden'>
...
export default transition(DIYDF,"");