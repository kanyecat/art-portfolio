      ...
      <div className={`${styles.paddingY} ${styles.paddingX} ${styles.flexStart}`}>
        <div className={`${styles.boxWidth} flex md:flex-nowrap flex-wrap justify-center`}>
          <div className='hidden h-[0] md:h-[auto] md:flex md:flex-1 md:visible md:flex-col'>
            <span className='md:text-start w-full md:text-[70px] text-[35px] text-white font-grandiflora px-6 md:mb-4 mb-3'>DEFENSE</span>
            <span className='md:text-start w-full md:text-[70px] text-[35px] text-white font-grandiflora px-6 md:mb-4 mb-3'>MECHANISM</span>
          </div>
