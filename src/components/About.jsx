            ...
            <div className='flex flex-1 flex-col pb-10 scroll-box md:h-[700px]'>
              ...
              <div className='flex flex-row md:pb-8 pb-6 md:pt-8 pt-6'>
                ...
                <div className='flex-[2]'>
                  ...
                  a connection with another instructor working as a software engineer. After stepping into the web developing industry, I learned how to empathize with the clients and provide them with solutions. Since then, my design
                  thinking skills have been improving in my main disciplines: art and mechnical enginneering.</span>
                </div>
              </div>
            </div>
